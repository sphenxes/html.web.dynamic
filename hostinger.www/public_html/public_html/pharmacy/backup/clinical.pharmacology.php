...
/*
$query = "INSERT INTO {$myTable} (firstlevel, secondlevel, atc, instructor, uses, adverseeffect, therapy, mechanism, physiology, clinical, comments, bibliography, source )
VALUES ('$myFirstLevel', '$mySecondLevel', '$myATC', '$myUses', '$myInstructor','$myAdverseEffect', '$myTherapy', '$myMechanism','$myPhysiology',  '$myClinical', '$myComments', '$myBibliography', '$mySource' )";
*/
