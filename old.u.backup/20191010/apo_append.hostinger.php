...
/*
$query = "Update {$myTable} SET {$myMainColumn} = case when {$myMainColumn} is null
or {$myMainColumn} = ''
then 'test'
else concat( {$myMainColumn},'newString')
end";
*/
...
/*
update heilpflanze
set contraindication = case when contraindication is null
then 'nullcontrainidcatin'
else concat (contraindication, '- myingrediants')
End
where plant like 'anis';
*/
...
<br>
<br>
<a href="http://localhost/apo_append.host.edit.html"> Click Here to Return to Home  </a>
