...
$query = "INSERT INTO {$myTable} (plant, botanic, arzneibuch, uses, contraindication, ingrediants, tees, images, source, comments, bibliography, sprache, signature, datum )
VALUES ('$myPlant', '$myBotanic', '$myArzneibuch', '$myUses', '$myContraindication', '$myIngredients', '$myTees', '$myImages', '$mySource', '$myComments', '$myBibliography', '$myLanguage', '$mySignature', CURDATE() )";
