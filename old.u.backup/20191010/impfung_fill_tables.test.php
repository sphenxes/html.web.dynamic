...
header('Refresh: 60; URL=http://localhost/impfung_fill_tables.test.html');
}
...
$query = "INSERT INTO {$myTable} (disease, symptoms, sideEffects, epidemiology, comments)
VALUES ('$myDisease', '$mySymptoms', '$mySideEffects', '$myEpidemiology', '$myComments')";
...
$query = "INSERT INTO {$myTable} (age, pregnancy, organdysfunction, sideEffects, comments)
VALUES ('$myAge', '$myPregnancy', '$myOrganDysfunction', '$mySideEffects', '$myComments')";
...
<br>
<br>
<a href= "http://localhost/impfung_fill_tables.test.html"> Click Here to Return to Home  </a>
