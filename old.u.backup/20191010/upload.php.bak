...
$connection = mysqli_connect($servername, $username, $password, $database);
	...
	$currentDir="/home/u233929990/domains/pharmacology.today/public_html/pharmacy/uploads/";
	...
	$uploadDirImages=$currentDir.$uploadImages."/".basename($_FILES['filename']['name']);
	$myTitle=$_POST['title'];
