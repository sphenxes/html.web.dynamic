...
//if(isset ($_POST['action']) && $_POST['action'] == 'munze') {
echo "--------------------" ."<br>";
...
elseif(isset($_POST['action']) && $_POST['action'] == 'paper'){
...
/*
$roundSumOfKassa=floor05($sumOfKassaMunze);


echo "Total Sum of Kassa is: " . $sumOfKassa . "<br>";
echo "Total Sum of Kassa is: " . $roundSumOfKassa . "<br>";
*/
