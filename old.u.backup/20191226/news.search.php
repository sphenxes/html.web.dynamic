...
$myDataSearch=$_POST['radiosearch'];
$myFirstDatum=$_POST['firstdatum'];
$mySecondDatum=$_POST['seconddatum'];
...
if ($count == '1'){
    ...
    echo "<tr> <th>Title </th> <th> Summary</th> <th> Subject</th> </tr>";
      ...
      $query = "SELECT * FROM {$myTable}
      where (datum between '$myFirstDatum' and '$mySecondDatum') ";
      echo "Start date: ".$myFirstDatum." "."End Date: "."$mySecondDatum";
      mysqli_query($connection, $query) or die('Error querying database.');
      $result = mysqli_query($connection, $query);
