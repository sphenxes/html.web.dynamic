...
$query = "INSERT INTO {$myTable} (category, subcategory, kunde, telephone, age, question, answer, source, product, dosage, administration, uses, comments, bibliography)
VALUES ('$myCategory', '$mySubCategory','$myKunde', '$myTelephone', '$myAge', '$myQuestion', '$myAnswer', '$mySource','$myProduct','$myDosage', '$myAdministration', '$myUses', '$myComments', '$myBibliography')";
